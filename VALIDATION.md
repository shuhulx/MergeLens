...
- offline reports, HTML escaping, safe CSV output, and multi-model chart grouping.
...
MergeLens has not yet been tested as a predictor of real merge outcomes. The synthetic example only checks deterministic software behavior.
